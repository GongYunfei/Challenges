...
// Created by Hao Zhang
	...
	switch($infoId) {
		case 'quote1':
			...
			break;
		case 'quote2':
			$info = 'I know quite certainly that I myself have no special talent; curiosity, 
							obsession and dogged endurance, combined with self-criticism have 
							brought me to my ideas.';
			break;
		case 'quote3':
			$info = 'Great spirits have always <strong>encountered violent opposition</strong> 
						from mediocre minds.';
			break;
		case 'quote4':
			$info = 'If my theory of relativity is proven successful, Germany will claim 
						...
						world. Should my theory prove untrue, France will say I am a 
